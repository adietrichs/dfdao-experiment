...
contract DaoContractPlayer {
    ...
    constructor(DarkForestCore _coreContract) {
        owner = msg.sender;
    ...
    function getRefreshedPlanet(uint256 _planetId) internal returns (DarkForestCore.Planet memory) {
    ...
    function processAndReturnPlanets(
        ...
        for (uint256 i = 0; i < _spacetimeRipIds.length; i++) {
            ...
            DarkForestCore.Planet memory planet = getRefreshedPlanet(planetId);
